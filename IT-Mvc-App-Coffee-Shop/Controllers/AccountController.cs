...
namespace IT_Mvc_App_Coffee_Shop.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AddUserToRole()
        {
            ...
            {
                model.Emails.Add(profile.Email);
            }
        ...
        public ActionResult AddUserToRole(AddUserToRole model)
        {
            try
            {
                ...
                Profile p = db.Profiles.Single(m => m.Email.Equals(model.SelectedEmail));
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            await UserManager.RemoveFromRolesAsync(ProfileId, "User");

            // This doesn't count login failures towards account lockout
            // To enable password failures to trigger account lockout, change to shouldLockout: true
            var result = await SignInManager.PasswordSignInAsync(model.Email, model.Password, model.RememberMe, shouldLockout: false);
           
            Profile p = db.Profiles.SingleOrDefault(m => m.Email.Equals(model.Email));
